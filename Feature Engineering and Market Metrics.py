import pandas as pd
import numpy as np
df = pd.read_csv(r"C:/Users/Admin/Desktop/crmls/sold_cleaned_data.csv")
...
df.to_csv(r"C:/Users/Admin/Desktop/crmls/sold_week6_features.csv", index=False)
summary_by_county.to_csv(r"C:/Users/Admin/Desktop/crmls/week6_summary_by_county.csv", index=False)
