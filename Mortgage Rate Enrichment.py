...
sold_with_rates.to_csv(r'C:\Users\Admin\Documents\IDX Exchangesold_enriched_final.csv', index=False)
listings_with_rates.to_csv(r'C:\Users\Admin\Documents\listings_enriched_final.csv', index=False)